...
class Analysis:
    ...
    def save_result(self, sub, filename):
        ...
        filename = os.path.join(os.path.dirname(__file__), self.result_dir + filename)
    ...
    def read_result(self, filename):
        ...
        if filename == "RIM-ts.txt":
            with open(os.path.join(os.path.dirname(__file__), 'results/RIM-ts.dat')) as file_object:
            ...
            with open(os.path.join(os.path.dirname(__file__), self.result_dir + filename)) as f:
                lines = f.readlines()
