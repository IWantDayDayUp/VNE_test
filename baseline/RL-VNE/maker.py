...
def simulate_events(path, number):
    '''
    读取 number 个虚拟网络及其自虚拟网络请求, 构成底层虚拟网络请求事件队列和子虚拟网络请求事件队列
    '''
...
if __name__ == '__main__':
    ...
    # 生成节点数为 100, 连通率为 0.5 的随机型物理网络
    # make_sub_wm(100, 50, 100)

    # # 生成节点数为 1×4×(1+3×8)=100, 连通率为 0.5 的Transit-Stub型物理网络
    # make_sub_ts(1, 3, 4, 8, 50, 100)
    #
    # # 平均每 1000 个时间单位内到达 40 个虚拟网络请求, 且虚拟节点数服从 10~20 的均匀分布, 请求资源服从 50~100 的均匀分布
