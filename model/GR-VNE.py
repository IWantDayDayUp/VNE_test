...
import pandas as pd
from network.GRNetModel import GRNet
...
class NetModel(BaseModel):
    ...
    def get_solution(self, net, s_nodes, v_nodes, s_links, v_links,
        ...
        for i in range(iter_time):
            ...
            loss = torch.dot(cross_entropy_loss,reward.squeeze())
...
def run():
    ...
    print(net)
    model.experience(net, data, load_model_path="GR-VNE", full_request=config.FULL_REQUEST)
